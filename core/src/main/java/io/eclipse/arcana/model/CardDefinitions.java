...
public class CardDefinitions {
    ...
    public static Array<Card> allMajor() {
        ...
        cards.add(major("Emperor",    "The Emperor",      4, 3, false));  // 4
        cards.add(major("Hierophant", "The Hierophant",   4, false));  // 5
        cards.add(major("Lovers",     "The Lovers",       3, false));  // 6
        cards.add(major("Chariot",    "The Chariot",      3, 2, false));  // 7
        cards.add(major("Strength",   "Strength",         3, 2, false));  // 8
        ...
        cards.add(major("HangedMan",  "The Hanged Man",   3, 2, false));  // 12
        ...
        cards.add(major("Star",       "The Star",         4, 3, false));  // 17
        cards.add(major("Moon",       "The Moon",         3, false));  // 18
        cards.add(major("Sun",        "The Sun",          3, 2, false));  // 19
    ...
    private static Card major(String id, String name, int cost, int reversedCost, boolean isExtinction) {
        return new Card(id, name, Card.ArcanaType.MAJOR, null, cost, reversedCost, isExtinction);
    }
