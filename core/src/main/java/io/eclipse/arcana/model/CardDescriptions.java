...
public final class CardDescriptions {
    ...
    private static void putMajor() {
        put("Fool",
            ...
            "복제 / 강제 사용");
        put("Magician",
            "손패 카드 1장을 계약 카드로 만듭니다. 이번 전투에서 0코스트가 되고 피해·회복·현재 코스트 변화량이 2배가 됩니다.",
        ...
        put("Lovers",
            ...
            "코스트 0 / 강제 사용");
        put("Chariot",
            "이 카드 이후 이번 턴에 사용한 카드는 필드로 가지 않고 손패에 유지됩니다.",
        ...
        put("Star",
            ...
            "조건부 드로우 / 보호막");
        put("Moon",
            "상대 손패를 숨기고 상대의 무작위 카드 1장을 강제로 사용합니다.",
